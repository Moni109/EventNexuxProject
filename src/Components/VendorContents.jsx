...
const EventLocationMap = ({ location }) => {
  ...
  return (
    <div className="bg-[#EEEEEE] p-4 rounded-lg shadow-md">
      ...
      <Typography variant="body1" className="mb-4 text-[#151515] flex items-center">
...
const PricingSection = ({ pricing }) => (
  ...
  <Grid item xs={12} id="pricing">
    ...
    <Typography variant="h6">Veg: ₹{pricing.vegPerPlate} per plate</Typography>
    <Typography variant="h6">Non-Veg: ₹{pricing.nonVegPerPlate} per plate</Typography>
    </Paper>
  </Grid>
);
...
const ContactSection = () => (
  <Grid item xs={12} id="contact">
    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} sm={6} md={3}>
        <Typography variant="body1">
          <strong>Address:</strong> 123 Main Street, City, State, ZIP Code, India
        </Typography>
      </Grid>
      <Grid item xs={12} sm={6} md={3}>
        <Typography variant="body1">
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <StarBorderPurple500OutlinedIcon fontSize="large" sx={{ ml: 2, color:'red' }} />
        ...
        >
          <LocationOnOutlinedIcon fontSize="large" sx={{ mr: 1, color:'red' }} />
