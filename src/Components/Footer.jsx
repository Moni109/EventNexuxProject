  ...
  return (
    <footer className="bg-pink-700 text-white">
      ...
      <div 
        ...
        style={{ backgroundImage: 'url(https://assets.cntraveller.in/photos/65cb33dd094a106c6b1e7b61/16:9/w_1024%2Cc_limit/1396308275)' }} // Replace with your image URL
      >
      ...
      <div className="container mx-auto py-10">
        <div className="text-center mb-10">
          <h3 className="text-2xl font-bold mb-4">EventNexus - One stop Destination for your event planning</h3>
